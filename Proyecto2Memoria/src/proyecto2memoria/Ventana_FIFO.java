...
public class Ventana_FIFO extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            if(fila.FilaVacia()){
                ...
                int tamaño = fila.regresaTamañoDeProcesoASalir();
                System.out.println("tamaño "+tamaño);
                if(tamaño == -1){
                    //no hay nada en inicio
                }else{
                    if(memoria.buscarEspacio(tamaño)){
                        Nodo x = fila.getPrimerNodo();
                        String noProceso = x.noProceso;
                        memoria.meterAMemoriaSinFila(noProceso, tamaño);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_FIFO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Ventana_FIFO().setVisible(true);
        });
    }
